...
public:
	...
	void pop(T& value) {
        ...
        // In this case the condition variable will not wait until another thread calls notify, instead we provide a predicate
        // to tell the condition variable when shall not wait or when is ok the wake up the thread...
